  ...
  <div class="py-5 text-center text-info">
    ...
    <div class="container">
      ...
      <form class="needs-validation" novalidate action="creationdecompte.php" method="POST">
        ...
        <div class="mb-3">
          <label for="email">E-mail du vendeur</label>
        ...
        <hr class="mb-4">
        <button class="btn btn-outline-info btn-light btn-lg btn-block" type="submit">Valider l'ajout du vendeur</button>
      </form>
