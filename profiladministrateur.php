...
<section class="jumbotron text-center">
  ...
  <div class="py-5 text-center text-info">
    <h2>Votre Profil</h2>
    <p class="lead">Vous êtes administrateur et vendeur sur AMA'ZONE ? Vous pouvez gérer les vendeurs et mettre en vente un ou plusieurs articles !</p>
  </div>
</section>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <a href="gerervendeurs.html"><img src="img/administrateur.jpg" alt="responsive" class="img-thumbnail"></a> </text></svg>
            <div class="card-body">
              <p class="card-text"> Gérer les vendeurs </p>
